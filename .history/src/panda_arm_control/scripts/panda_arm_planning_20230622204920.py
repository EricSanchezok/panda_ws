...
def interpolate_trajectory(original_trajectory, num_points):
    interpolated_trajectory = traj_msg.JointTrajectory()
    ...
    for t in times_interp:
        ...
        point_interp = traj_msg.JointTrajectoryPoint(positions=positions_interp, time_from_start=rospy.Duration(t))
...
def main():
    ...
    # 打印点的个数
    print("point number: ", len(joint_trajectory.points))
