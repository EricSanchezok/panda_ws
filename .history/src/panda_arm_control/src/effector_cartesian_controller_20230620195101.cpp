...
bool EffectorCartesianController::init(hardware_interface::RobotHW* robot_hardware,
  ...
  ros::Subscriber sub_effector_control_param_ = nh.subscribe<panda_arm_control::effector_control_param>("effector_control_param_node",20,&EffectorCartesianController::controlParamCallback);
