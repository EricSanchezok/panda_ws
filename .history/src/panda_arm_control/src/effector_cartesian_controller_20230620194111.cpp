...
#include "panda_arm_control/Person.h"
...
void EffectorCartesianController::controlParamCallback(const panda_arm_control::control_param::ConstPtr& msg) {
  // 在这里处理接收到的消息
...
PLUGINLIB_EXPORT_CLASS(panda_arm_control_pkg::EffectorCartesianController,
