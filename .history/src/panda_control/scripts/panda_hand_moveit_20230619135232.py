...
class panda_moveit:
    def __init__(self):
        ...
        self.move_value = control_srvResponse()
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if panda.if_init == False:
            ...
            panda.move_value.vector0 += panda.control_value.vector0
            panda.move_value.vector1 += panda.control_value.vector1
            panda.move_value.vector2 += panda.control_value.vector2
