    ...
    while not rospy.is_shutdown():
        ...
        if panda.if_init == False:
            ...
            if panda.control_value.task == "position":
                ...
                target_pose.position.x = panda.task_start_pose.position.x + panda.control_value.x - panda.task_start_control_value.x
                target_pose.position.y = panda.task_start_pose.position.y + panda.control_value.y - panda.task_start_control_value.y
                target_pose.position.z = panda.task_start_pose.position.z + panda.control_value.z - panda.task_start_control_value.z
