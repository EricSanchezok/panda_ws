    ...
    while not rospy.is_shutdown():
        ...
        if panda.if_init == False:
            ...
            if panda.control_value.task == "position":
                ...
                target_pose.position.x = panda.task_start_pose.position.x + control_value.vector0
                target_pose.position.y = panda.task_start_pose.position.y + control_value.vector1
                target_pose.position.z = panda.task_start_pose.position.z + control_value.vector2
