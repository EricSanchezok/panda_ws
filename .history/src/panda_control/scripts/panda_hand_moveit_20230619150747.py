    ...
    while not rospy.is_shutdown():
        ...
        if panda.if_init == False:
            ...
            if panda.control_value.task == "position":
                ...
                target_pose.position.x = panda.task_start_pose.position.x + (panda.control_value.vector0 - panda.task_start_control_value.vector0) * 0.5
                target_pose.position.y = panda.task_start_pose.position.y + (panda.control_value.vector1 - panda.task_start_control_value.vector1) * 0.5
                target_pose.position.z = panda.task_start_pose.position.z + (panda.control_value.vector2 - panda.task_start_control_value.vector2) * 0.5
