...
init_position: x: 0.3068905573918846
y: -2.289840334388302e-10
z: 0.590282049301368 init_orientation_q: x: 0.9238795334199068
y: -0.38268343017148676
z: -2.4431769379706562e-11
w: 1.3416157368712858e-11
...
def moveit_control():
    ...
    while not rospy.is_shutdown():
        ...
        if if_init == False:
            ...
            target_pose.position = init_position
            target_pose.orientation = init_orientation
            ...
            if control_value.task == "position":
                ...
                target_pose = geometry_msgs.msg.Pose()
                target_pose.position.x = end_effector_pose + control_value.vector0
                target_pose.position.y = end_effector_pose + control_value.vector1
                target_pose.position.z = end_effector_pose + control_value.vector2

                target_pose.orientation = end_effector_pose.orientation

                # 运动到目标位置
                go_to(group, target_pose, isWait=False)
