...
# 初始位置
init_position = [0.30691096167070825, -3.232410501389251e-05, 0.5902656849203191]
init_orientation_q = [-0.9238602572516486, 0.38272996352759625, 5.233870179838188e-06, 7.854241932417396e-06]
init_orientation = tf.transformations.euler_from_quaternion(init_orientation_q)
当前末端位置： position: 
  x: 0.3069155025811837
  y: 1.1206712491293856e-05
  z: 0.5902933382353311
orientation: 
  x: 0.9238732550170593
  y: -0.3826985843211034
  z: 4.5769895296965384e-05
  w: 1.1310341694220348e-05
...
def moveit_control():
    ...
    print("当前末端位置：", end_effector_pose)
