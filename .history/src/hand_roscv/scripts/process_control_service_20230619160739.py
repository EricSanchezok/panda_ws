...
class server:
    ...
    def server_process_frame(self):
        ...
        self.fliter_point, self.target_image = pp.point_proccessing(self.pred_index, self.results, self.ori_color_image, self.aligned_depth_frame, self.L515, self.dt, self.filter_init)
...
def doReq(req):
    ...
    if req.request_num == 1:
        ...
        server.task_distributor.if_lock = False
