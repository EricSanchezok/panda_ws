...
def doReq(req):
    ...
    if req.request_num == 0:
        ...
        value[0] = server.task_distributor.work_mode
        value[1] = server.task_distributor.work_speed
        value[2] = server.task_distributor.work_direction
        value[3] = server.task_distributor.work_distance
