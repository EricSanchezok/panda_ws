...
def doReq(req):
    ...
    if req.request_num == 0:
        ...
        return [task_distributor.work_mode, task_distributor.srv_value[0], task_distributor.srv_value[1], task_distributor.srv_value[2]]
 
              srv.task = task_distributor.work_mode
              srv.vector0 = task_distributor.srv_value[0]
              srv.vector1 = srv_value[1]
              srv.vector2 = srv_value[2]
