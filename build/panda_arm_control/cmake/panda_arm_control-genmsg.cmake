...
set(MSG_I_FLAGS "-Ipanda_arm_control:/home/ericsanchez/ros/ros1/panda_ws/src/panda_arm_control/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
add_custom_target(_panda_arm_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_arm_control" "/home/ericsanchez/ros/ros1/panda_ws/src/panda_arm_control/msg/effector_control_param.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/panda_arm_control)
  install(CODE "execute_process(COMMAND \"/home/ericsanchez/anaconda3/envs/dl/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/panda_arm_control\")")
  # install generated code
  install(
